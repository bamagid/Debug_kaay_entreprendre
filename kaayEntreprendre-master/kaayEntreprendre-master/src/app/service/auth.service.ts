...
export class AuthService implements OnInit{
  ...
  inscriptionNovice(user: any): Observable<any> {
    ...
    return this.http.post<any>(`${this.apiUrl}/ajouter-utilisateur-entrepreneur-novice`, user ,httpOptions);
  }
  inscriptionExperimente(user: any): Observable<any> {
    ...
    return this.http.post<any>(`${this.apiUrl}/ajouter-utilisateur-entrepreneur-experimente`, user, httpOptions);
  }
